                            ...
                            <div class="bs-stepper-content">
                                ...
                                <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                                    <div class="form-group">
                                        <label class="text-black"  for="exampleInputEmail1">Nom <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                            placeholder="nom du projet" name="name" @required(true)>
                                    </div>
                                    <div class="form-group">
                                        <label class="text-black"  for="exampleInputPassword1">Type <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label class="text-black"  for="exampleInputFile">Cible <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                            placeholder=" cible" name="target" @required(true)>
                                    </div>
                                    <div class="form-group">
                                        <label class="text-black"  for="exampleInputFile">Début <span class="text-danger">*</span></label>
                                ...
                                <div id="information-part" class="content" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label class="text-black"  for="exampleInputFile " class="text-black">Sponsor <span class="text-danger">*</span></label>
                                            <div class="form-group">
                                                <select class="select2" data-placeholder="Any" style="width: 100%;"
                                                    ...
                                                    <input type="hidden" id="sponsor_phone_number" name="sponsor_phone_number">
                                        ...
                                        <div class="form-group">
                                            <label class="text-black" >Descriptiion <span class="text-danger">*</span></label>
                                            <textarea class="form-control" rows="3" placeholder="Description" name="description"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="text-black"  for="exampleInputFile">Documents<span class="text-black-50">(optionel)</span></label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="doc" name="file[]" multiple>
                                                    <label class="text-black"  class="custom-file-label" for="doc">fichier</label>
                                                </div>
