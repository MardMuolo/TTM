            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    ...
                    <table class="table table-striped projects">
                        ...
                        <tbody>
                            ...
                            <tr class="text-muted"><td colspan="3" class="text-center">Aucune donnée</td></tr>
                            @endif
                            @foreach ($directions as $direction)
                                <tr>
                                    ...
                                    <td class="project-actions text-center">
                                        ...
                                        <a class="btn btn-info btn-sm" href="{{ route('directions.update', $direction) }}" onclick="edit(event)" direction = "{{ $direction->name }}" directeur="{{$direction->direction_users?->Where('is_director',true)->first()?->user?->name}}" directeur_email="{{$direction->direction_users?->Where('is_director',true)->first()?->user?->email}}" data-toggle="modal" data-target="#edit">
                                            <i class="fas fa-pencil-alt">
                                            </i>
                                            
                                        </a>
                                        <a class="btn btn-danger btn-sm" href="{{ route('directions.destroy', $direction) }}" onclick="supprimer(event)" item="Voulez-vous supprimer la direction {{ $direction->name }}" data-toggle="modal" data-target="#supprimer">
                ...
                <div class="card-footer clearfix">
                    <ul class="pagination pagination-xl m-0 float-right">
                        <li class="page-item m-2"><a class="page-link" href="{{$directions->previousPageUrl()}}">« Précedant</a></li>
                        <li class="page-item m-2"><a class="page-link" href="{{$directions->nextPageUrl()}}">» Suivant</a></li>
                    </ul>
                </div>
