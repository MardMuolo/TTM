                ...
                <div class="os-viewport">
                    <div style="position: absolute; top: 0; left: 0;">
                        <a class="nav-link" data-widget="control-sidebar" data-controlsidebar-slide="true"
                            data-target="#edit-edit" href="#edit-edit"
                            role="button">
                                ...
                                <div class="card-body">
                                    <div class="col-xm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="category_edit" id="category_edit" class="form-control" style="width: 100%;" required>
                                                <option  value="">Sélectionnez une catégorie</option>
                                                @foreach ($categoryDemandes as $categoryDemande)
                                                <option id="cat_edit_{{$categoryDemande->id}}" value="{{$categoryDemande->id}}">{{$categoryDemande->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="demande" id="demande_edit" class="form-control" style="width: 100%;" required>
                                                ...
                                                <option class="item_demande_edit" value="{{$oneDemande->id}}"  data-cat="cat_edit_{{$oneDemande->category_demande_id}}">{{$oneDemande->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xm-6">
                                        <div class="form-group">
                                            ...
                                            {{-- <select class="form-control manager_edit  col-sm-12" style="width: 100%;"
                                            ...
                                            <select class="form-control col-sm-12" name="contributeur" >
                                                <option value=""></option>
                                                @foreach ($allContributeurs as $oneContributeur)
                                                <option class="item_demande_edit" value="{{$oneContributeur->id}}"  >{{$oneContributeur->username}} {{$oneContributeur->email}} {{$oneContributeur->first_name}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control col-sm-12" name="manager" id="manager_edit">
                                                <option value=""></option>
                                                @foreach ($allContributeurs as $oneContributeur)
                                                <option class="item_demande_edit" value="{{$oneContributeur->id}}"  >{{$oneContributeur->username}} {{$oneContributeur->email}} {{$oneContributeur->first_name}} </option>
                                                @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="deadline_unit">
                                                    <option value="days"
                                                    {{-- {{ $ancienneUnite == 'days' ? 'selected' : '' }} --}}
                                                        >Jours</option>
                                                    <option value="hours"
                                                    {{-- {{ $ancienneUnite == 'hours' ? 'selected' : '' }} --}}
                                                        >Heures
                                                    </option>
                                                    <option value="minutes"
                                                    {{-- {{ $ancienneUnite == 'minutes' ? 'selected' : '' }} --}}
                                                        >Minutes
                                                    </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label"  for="customFile">Choose file</label>
                                                ...
                                                <span class="text-muted" id="demande_file" >Fichier actuel : </span>
                                    ...
                                    <div class="col-xm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" rows="5" placeholder="Enter ..." id="description_edit" required></textarea>
                                        </div>
                                    </div>
